...
######################################################
#   Section 6 correlations across DVs   #
###################################################### 


```{r correlations across dvs}

#neg affect x time trying

#visualize
ggplot(BG,mapping =aes(x=TotalNegFrames/NumAffectFrames,y=TimeTrying))+geom_point()+geom_smooth(method="lm",se=F,color="gray",alpha=.7)+ylab("Time Trying (s)")+xlab("Proportion Negative Affect")

#create new neg affect variable to correlate with time trying
mutate(BG, PropNegAffect = TotalNegFrames/NumAffectFrames)->BG
cor.test(BG$PropNegAffect,BG$TimeTrying)

#pos affect x time trying

#visualize
ggplot(BG,mapping =aes(x=TotalPosFrames/NumAffectFrames,y=TimeTrying))+geom_point()+geom_smooth(method="lm",se=F,color="gray",alpha=.7)+ylab("Time Trying (s)")+xlab("Proportion Positive Affect")

#create new pos affect variable to correlate with time trying
mutate(BG, PropPosAffect = TotalPosFrames/NumAffectFrames)->BG
cor.test(BG$PropPosAffect,BG$TimeTrying)
...
#help seeking x force

ggplot(BG,mapping =aes(x=HelpSeekingNum_exp,y=MaxPSI))+geom_point()+geom_smooth(method="lm",se=F,color="gray",alpha=.7)+ylab("Max PSI")+xlab("Number of Help Requests")

cor.test(BG$HelpSeekingNum_exp, BG$MaxPSI)
